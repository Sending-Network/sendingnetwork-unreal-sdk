...
//    private string[] m_libraries;
    ...
    public bool Load(ReadOnlyTargetRules target, ModuleRules rules, bool useSystemCompiler)
    {
        ...
        m_cmakeTargetPath=Directory.GetParent(m_cmakeTargetPath).FullName+"/Plugins/SdnClient/Source/SdnClient";
...
public class SdnClient : ModuleRules
{
	public SdnClient(ReadOnlyTargetRules Target) : base(Target)
	{
		PCHUsage = ModuleRules.PCHUsageMode.UseExplicitOrSharedPCHs;

		PublicDefinitions.Add("SPDLOG_FMT_EXTERNAL=1");
		// Add(Target, this, "sdn_client", Path.Combine(this.ModuleDirectory, "../SdkSrc"), "-DHUNTER_ENABLED=ON");
    ...
    public static bool AddDefault(ReadOnlyTargetRules target, ModuleRules rules)
    {
        var srcPath = Path.Combine(rules.ModuleDirectory, "../../Plugins/SdnClient/Source/SdkSrc");
        return Add(target, rules, "sdn_client", srcPath, "-DHUNTER_ENABLED=ON");
    }
