...
TEST(Pushrules, GetGlobalRuleset)
{
    ...
    client->login("alice", "secret", [client](const sdn::responses::Login &res, RequestErr err) {
        check_error(err);
        validate_login("@alice:" + server_name(), res);

        client->get_pushrules(
          [](const sdn::pushrules::GlobalRuleset &, RequestErr err) { EXPECT_TRUE(!err); });
    });
    client->close();
}
...
TEST(Pushrules, GetRuleset)
{
    ...
    client->login("alice", "secret", [client](const sdn::responses::Login &res, RequestErr err) {
        ...
        client->get_pushrules("global",
                              ...
                              [](const sdn::pushrules::PushRule &rule, RequestErr err) {
                                  EXPECT_TRUE(!err);
...
TEST(Pushrules, PutAndDeleteRuleset)
{
    ...
    client->login("alice", "secret", [client](const sdn::responses::Login &res, RequestErr err) {
        ...
        sdn::pushrules::PushRule rule;
        rule.pattern = "cake";
        rule.actions = {sdn::pushrules::actions::notify{},
                        sdn::pushrules::actions::set_tweak_sound{"cakealarm.wav"}};
...
TEST(Pushrules, RulesetEnabled)
{
    ...
    client->login("alice", "secret", [client](const sdn::responses::Login &res, RequestErr err) {
        ...
        client->get_pushrules_enabled(
          ...
          "content",
          ".m.rule.contains_user_name",
          [client](const sdn::pushrules::Enabled &enabled, RequestErr err) {
              EXPECT_TRUE(!err);
...
TEST(Pushrules, Actions)
{
    ...
    client->login("alice", "secret", [client](const sdn::responses::Login &res, RequestErr err) {
        ...
        sdn::pushrules::actions::Actions actions = {
          {sdn::pushrules::actions::notify{},
           sdn::pushrules::actions::set_tweak_sound{"cakealarm.wav"},
           sdn::pushrules::actions::set_tweak_highlight{}}};
...
TEST(Pushrules, RoomRuleMute)
{
    ...
    client->login("alice", "secret", [client](const sdn::responses::Login &res, RequestErr err) {
        ...
        client->create_room(req, [client](const sdn::responses::CreateRoom &res, RequestErr err) {
            check_error(err);
            ASSERT_TRUE(res.room_id.localpart().size() > 10);
            EXPECT_EQ(res.room_id.hostname(), server_name());

            sdn::pushrules::PushRule rule;
            rule.actions = {sdn::pushrules::actions::dont_notify{}};
            sdn::pushrules::PushCondition condition;
            ...
            client->put_pushrules(
              "global", "override", res.room_id.to_string(), rule, [](sdn::http::RequestErr &err) {
                  check_error(err);
                  EXPECT_TRUE(!err);
              });
        });
...
TEST(Pushrules, RoomRuleMentions)
{
    ...
    client->login("alice", "secret", [client](const sdn::responses::Login &res, RequestErr err) {
        ...
        client->create_room(req, [client](const sdn::responses::CreateRoom &res, RequestErr err) {
            ...
            client->put_pushrules(
              "global", "room", res.room_id.to_string(), rule, [](sdn::http::RequestErr &err) {
                  check_error(err);
                  EXPECT_TRUE(!err);
              });
        });
...
{
    sdn::pushrules::PushRule event_match_rule;
    event_match_rule.actions = {
      sdn::pushrules::actions::notify{},
      sdn::pushrules::actions::set_tweak_highlight{},
    };
    event_match_rule.conditions.push_back(sdn::pushrules::PushCondition{
      .kind    = "event_match",
      .key     = "content.body",
      .pattern = "honk",
      .is      = "",
    ...
    sdn::events::RoomEvent<sdn::events::msg::Text> textEv{};
    ...
    auto testEval = [actions = event_match_rule.actions,
                     &textEv](const sdn::pushrules::PushRuleEvaluator &evaluator) {
        sdn::pushrules::PushRuleEvaluator::RoomContext ctx{};
    ...
    sdn::pushrules::PushRuleEvaluator content_evaluator{content_ruleset};
...
TEST(Pushrules, DisplaynameMatches)
{
    ...
    auto testEval = [actions = event_match_rule.actions,
        ...
        sdn::pushrules::PushRuleEvaluator::RoomContext ctxEmpty{};
...
TEST(Pushrules, PowerLevelMatches)
{
    ...
    auto testEval =
      [actions = event_match_rule.actions](const sdn::pushrules::PushRuleEvaluator &evaluator) {
          sdn::events::RoomEvent<sdn::events::msg::Text> textEv{};
          ...
          sdn::events::state::PowerLevels pls;
...
TEST(Pushrules, MemberCountMatches)
{
    auto testEval = [](const std::string &is, bool lt, bool eq, bool gt) {
        ...
        sdn::pushrules::Ruleset ruleset;
        ruleset.override_.push_back(event_match_rule);
        sdn::pushrules::PushRuleEvaluator evaluator{ruleset};
  ...
  "global": {
    ...
    "room": [
      ...
      },
      {
        ...
        "default": false,
        "enabled": true,
        "rule_id": "!gXyPibMbVgafeoHKIc:sdn.org"
      },
      {
        "actions": [
          "dont_notify"
    ...
    sdn::pushrules::GlobalRuleset ruleset = raw_rule.get<sdn::pushrules::GlobalRuleset>();
    ...
    json raw_event = R"(
{
    "content": {
        ...
        "formatted_body": "<mx-reply><blockquote><a href=\"https://sdn.to/#/!UbCmIlGTHNIgIRZcpt:nheko.im/$ifmL9zdEQjnec3LlgxX0Bqr7xVm0agynZBglt7q59AU\">In reply to</a> <a href=\"https://sdn.to/#/@lordmzte:mzte.de\">@lordmzte:mzte.de</a><br/>btw, im still not getting notification on replies, only explicit mentions.</blockquote></mx-reply>probably because of your username :p",
    ...
    auto text      = raw_event.get<sdn::events::RoomEvent<sdn::events::msg::Text>>();
    sdn::pushrules::PushRuleEvaluator evaluator{ruleset.global};
    sdn::pushrules::PushRuleEvaluator::RoomContext ctx{};

    auto actions = evaluator.evaluate({text}, ctx, {});

    auto notifies = [](const std::vector<sdn::pushrules::actions::Action> &a) {
        for (const auto &action : a) {
            if (action == sdn::pushrules::actions::Action{sdn::pushrules::actions::notify{}}) {
                return true;
            }
        }
        return false;
    ...
    json raw_event = R"(
{
    ...
    auto text      = raw_event.get<sdn::events::RoomEvent<sdn::events::msg::Reaction>>();
    sdn::pushrules::PushRuleEvaluator evaluator{ruleset.global};
    sdn::pushrules::PushRuleEvaluator::RoomContext ctx{};
...
TEST(Pushrules, NormalMessageDoesNotHighlight)
{
  ...
  "device": {}
    ...
    for (const auto &action : actions) {
        EXPECT_NE(action,
                  sdn::pushrules::actions::Action{sdn::pushrules::actions::set_tweak_highlight{}});
    }
}
    ...
    json related_raw_event = R"(
{
    ...
    auto text         = raw_event.get<sdn::events::RoomEvent<sdn::events::msg::Text>>();
    auto related_text = related_raw_event.get<sdn::events::RoomEvent<sdn::events::msg::Text>>();
    sdn::pushrules::PushRuleEvaluator evaluator{ruleset.global};
    sdn::pushrules::PushRuleEvaluator::RoomContext ctx{};
    ...
    raw_rule = R"(
{
  "global": {
    ...
    ruleset = raw_rule.get<sdn::pushrules::GlobalRuleset>();
    sdn::pushrules::PushRuleEvaluator evaluator1{ruleset.global};
    EXPECT_TRUE(
    ...
    raw_rule = R"(
{
  "global": {
    ...
    ruleset = raw_rule.get<sdn::pushrules::GlobalRuleset>();
    sdn::pushrules::PushRuleEvaluator evaluator2{ruleset.global};
    EXPECT_TRUE(
    ...
    raw_rule = R"(
{
  "global": {
    ...
    ruleset = raw_rule.get<sdn::pushrules::GlobalRuleset>();
    sdn::pushrules::PushRuleEvaluator evaluator3{ruleset.global};
    EXPECT_FALSE(
    ...
    raw_event = R"(
{
    ...
    text      = raw_event.get<sdn::events::RoomEvent<sdn::events::msg::Text>>();
    EXPECT_FALSE(
      notifies(evaluator.evaluate({text},
                                  ctx,
                                  {
    ...
    raw_rule = R"(
{
  "global": {
    ...
    ruleset = raw_rule.get<sdn::pushrules::GlobalRuleset>();
    sdn::pushrules::PushRuleEvaluator evaluator4{ruleset.global};
    EXPECT_TRUE(
    ...
    raw_event  = R"(
{
    ...
    auto emote = raw_event.get<sdn::events::RoomEvent<sdn::events::msg::Emote>>();

    ruleset = raw_rule.get<sdn::pushrules::GlobalRuleset>();
    sdn::pushrules::PushRuleEvaluator evaluator5{ruleset.global};
    EXPECT_TRUE(
                ...
                "conditions": [
                    {
                        "key": "room_id",
                        "kind": "event_match",
                        "pattern": "!eMqocHMcvmMFuUpioO:sdn.org"
                    }
                ],
                "default": false,
                "enabled": true,
                "rule_id": "!eMqocHMcvmMFuUpioO:sdn.org"
            },
            {
                "actions": [
                    "dont_notify"
