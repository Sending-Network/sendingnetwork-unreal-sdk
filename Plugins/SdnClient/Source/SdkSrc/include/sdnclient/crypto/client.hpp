...
#include "sdnclient/crypto/objects.hpp"
...
public:
    ...
    struct OnlineKeyBackupSetup
    {
        ...
        sdn::crypto::BinaryBuf privateKey;
        //! The backup version data including auth data to be sent to the server.
        sdn::responses::backup::BackupVersion backupVersion;
    };
    ...
    struct SSSSSetup
    {
        ...
        sdn::secret_storage::AesHmacSha2KeyDescription keyDescription;
    ...
    sdn::requests::UploadKeys create_upload_keys_request(const OneTimeKeys &keys,
                                                         const OneTimeKeys &fallback_keys);
    //! Prepare an empty /keys/upload request.
    sdn::requests::UploadKeys create_upload_keys_request();
...
std::string
encrypt_exported_sessions(const sdn::crypto::ExportedSessionKeys &keys, const std::string &pass);
