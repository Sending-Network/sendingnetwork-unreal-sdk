...
//! Wrapper around the olm object for inbound group sessions used to decrypt messages in sdn
//! rooms.
...
//! Wrapper around the outbound olm session object used to encrypt outbound group messages in sdn
//! rooms.
...
//! Allocates an olm object using the sdnclient wrapper type.
template<class T>
