...
{
    //! The event id.
    sdn::identifiers::Event event_id;
...
using RoomAccountDataEvents = std::vector<sdn::events::collections::RoomAccountDataEvents>;
//! Multiple TimelineEvents.
using TimelineEvents = std::vector<sdn::events::collections::TimelineEvents>;
//! Multiple StateEvents.
using StateEvents = std::vector<sdn::events::collections::StateEvents>;
//! Multiple StrippedEvents.
using StrippedEvents = std::vector<sdn::events::collections::StrippedEvents>;
//! Multiple DeviceEvents.
using DeviceEvents = std::vector<sdn::events::collections::DeviceEvents>;
//! Multiple EphemeralEvents.
using EphemeralEvents = std::vector<sdn::events::collections::EphemeralEvents>;

namespace states = sdn::events::state;
namespace msgs   = sdn::events::msg;
